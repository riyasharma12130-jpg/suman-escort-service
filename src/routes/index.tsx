...
// Indian escort names
const escortNames = [
  "Suman Sharma", "Ananya Patel", "Suman Reddy", "Meera Singh", 
  "Suman Desai", "Neha Kapoor", "Pooja Malhotra", "Sneha Joshi",
...
// Escort profiles
const escorts = [
  { name: "Suman Sharma", age: 24, location: "Jaipur", price: "₹5,000", img: imageList[1], desc: "Premium independent call girl in Jaipur. Elegant, sophisticated, and available for discreet incall and outcall services in Malviya Nagar and Vaishali Nagar.", bestFor: "Luxury Experiences" },
  ...
  { name: "Suman Desai", age: 25, location: "Jaipur", price: "₹6,500", img: imageList[5], desc: "Stunning beauty with excellent communication skills. The ideal dinner and date companion for elite gentlemen.", bestFor: "Dinner Dates" },
            ...
            {[
              {
                ...
                text: "Booked Priya for an evening through Suman Escorts Jaipur and the experience was top notch. Very professional, discreet, and punctual. Profile photos were 100% real. Will book again through Suman Escort!",
              ...
              },
              {
                ...
                text: "Natasha for corporate event — stunning, spoke perfect English, handled everything perfectly. Suman VIP service is unmatched for Jaipur Call Girls. Highly recommended!",
              ...
              },
              {
                ...
                text: "WhatsApp response instant on Suman's number. Meera punctual, gorgeous, very comfortable. Total privacy maintained throughout. Suman is the most trustworthy escort agency in Jaipur!",
                package: "2-Hour Package - Mansarovar"
              },
              {
                initial: "D", bg: "bg-pink-500",
                name: "Dev R.", date: "May 2026 - Raja Park",
                text: "First time using any escort service. Suman Call Girls made it smooth, professional, safe. Riya exceeded all expectations. Real photos, real experience. 10/10!",
