...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "call girls in Jaipur, Jaipur escort girls, book call girls in Jaipur, escort service Jaipur, premium escorts Jaipur, independent escorts Jaipur" },
    ],
  }),
});
...
// Service offerings
const services = [
  { name: "Incall Service", desc: "Discreet service at our premium location in Jaipur. Booking confirm with advance payment.", duration: "Available 24/7", price: "₹5,000", img: imageList[1] },
    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <section className="relative flex min-h-screen items-center justify-center">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-6 text-center animate-fade-in">
          ...
          <h1 className="font-display text-5xl md:text-7xl lg:text-8xl font-light leading-[1.05]">
            Premium Call Girls <span className="italic text-gold-gradient">in Jaipur</span>
            <br />
            Book Your Perfect Companion
          </h1>
          <p className="mt-8 mx-auto max-w-xl text-base md:text-lg text-muted-foreground leading-relaxed">
            Verified, discreet escort service in Jaipur. Available 24/7 for incall and outcall services.
          </p>
      ...
      <section className="relative py-32 bg-radial-glow">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-light leading-tight">
            Jaipur's Most Trusted Call Girl & Escort Service
          </h2>
      ...
      <section id="escorts" className="py-24 border-y border-border bg-card/40">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-16">
            ...
            <h2 className="font-display text-4xl md:text-5xl font-light">Meet Our Premium Escorts in Jaipur</h2>
          </div>
      ...
      <section className="relative py-32 border-t border-border">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <h2 className="font-display text-4xl md:text-6xl font-light leading-tight mb-6">Book Your Jaipur Escort Now</h2>
