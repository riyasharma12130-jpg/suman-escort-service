...
export const Route = createFileRoute("/privacy")({
  ...
  head: () => ({
    meta: [
      { title: "Privacy Policy | Suman Escorts" },
        ...
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="prose prose-invert max-w-none text-muted-foreground">
            ...
            <p className="text-lg leading-relaxed mb-8">
              At Suman Escorts, we understand that discretion and confidentiality are the most important factors for our clients. This Privacy Policy outlines our strict data handling practices and our commitment to ensuring that your interactions with our agency remain completely private and untraceable.
            </p>
