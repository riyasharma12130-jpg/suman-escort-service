...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Riya Escort Service" },
      { property: "og:title", content: "Escort Service Jaipur | Premium Spa & Call Girls in Sindhi Camp" },
      { property: "og:description", content: "Looking for the best escort service Jaipur? Visit Riya Escort Service in Sindhi Camp for exclusive and premium companion services. Available 24/7." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Escort Service Jaipur | Premium Spa & Call Girls in Sindhi Camp" },
      { name: "twitter:description", content: "Looking for the best escort service Jaipur? Visit Riya Escort Service in Sindhi Camp for exclusive and premium companion services. Available 24/7." },
    ],
    links: [
