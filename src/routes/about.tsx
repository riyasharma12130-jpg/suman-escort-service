...
export const Route = createFileRoute("/about")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Learn more about Suman Escort Service, the most trusted and genuine Jaipur escorts agency. We provide 100% independent call girls with real pics and no advance payment." },
      { name: "keywords", content: "about escort service Jaipur, Suman Escort Service history, genuine call girls in Jaipur, premium spa Jaipur, Koramangala spa" },
    ],
  }),
});
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="pt-32 pb-16 bg-radial-glow">
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          <h1 className="font-display text-4xl md:text-6xl font-light mb-6">About Suman Escort Service</h1>
        ...
        <div className="mx-auto max-w-4xl px-6">
          <div className="space-y-12 text-muted-foreground leading-relaxed">
            <div>
              ...
              <p className="mb-4">
                For years, Suman Escort Service has stood as the gold standard for luxury companionship and premium relaxation in the Garden City. When you are looking for an <strong>escort service Jaipur</strong>, you are not just looking for a meeting; you are seeking a meticulously curated experience that prioritizes your satisfaction, privacy, and safety.
              </p>
              <p>
            ...
            <div className="bg-card border border-border p-8 rounded-lg">
              ...
              <p className="mb-4">
                We understand that every client has unique desires. Suman Escort Service boasts the most diverse gallery in Rajasthan. We offer:
              </p>
