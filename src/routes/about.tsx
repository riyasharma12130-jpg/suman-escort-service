...
export const Route = createFileRoute("/about")({
  ...
  head: () => ({
    meta: [
      { title: "About Us | Indian Escorts Agency & Independent Call Girls" },
      { name: "description", content: "Learn more about Suman Escorts, the most trusted and genuine Jaipur escorts agency. We provide 100% independent call girls with real pics and no advance payment." },
      { name: "keywords", content: "about escort service India, Suman Escorts history, genuine call girls in India, premium spa Jaipur, Mansarovar spa" },
    ],
  }),
});
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="pt-32 pb-16 bg-radial-glow">
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          <h1 className="font-display text-4xl md:text-6xl font-light mb-6">About Suman Escorts</h1>
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Discover why we are recognized as the premier escort service India has to offer, delivering unforgettable experiences with genuine and verified companions.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-6">
          <div className="space-y-12 text-muted-foreground leading-relaxed">
            <div>
              ...
              <p className="mb-4">
                For years, Suman Escorts has stood as the gold standard for luxury companionship and premium relaxation in all major cities. When you are looking for an <strong>escort service India</strong>, you are not just looking for a meeting; you are seeking a meticulously curated experience that prioritizes your satisfaction, privacy, and safety.
              </p>
              <p>
                Located conveniently in the heart of the city at <strong>Mansarovar</strong>, our establishment serves as a sanctuary for those looking to escape the mundane. Our deep understanding of what constitutes a truly premium service has allowed us to become the most sought-after destination for gentlemen and travelers alike who want to book call girls in India.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mb-4">
                Beyond being a premier escort service India, we are a holistic relaxation destination. Our facilities in Mansarovar are equipped to provide you with a transcendent spa experience. From the moment you step through our doors, you will be enveloped in an atmosphere of luxury and tranquility. 
              </p>
              <p>
                Our services are tailored to melt away stress and leave you rejuvenated. By combining the therapeutic benefits of a premium spa with the enchanting company of our exclusive call girls in India, we guarantee an experience that satisfies both body and mind. It is this unique synthesis of wellness and companionship that has cemented our reputation at the very top.
              </p>
            </div>
            ...
            <div className="bg-card border border-border p-8 rounded-lg">
              ...
              <p className="mb-4">
                In the luxury adult entertainment and premium spa industry, health and hygiene are non-negotiable. At Suman Escorts, we have instituted the highest health protocols for both our clients and our companions. Our incall facility in <strong>Mansarovar</strong> is sanitized daily, and fresh linens, premium toiletries, and a completely immaculate environment are guaranteed for every single booking.
              </p>
              <p className="mb-4">
                Furthermore, we prioritize the safety and well-being of our <strong>Indian escort girls</strong> just as much as our clients. We operate a secure, verified booking system that protects the identities of everyone involved. This mutual respect creates a stress-free environment where both you and your companion can truly relax and enjoy the moment without any underlying anxieties.
              </p>
            </div>
            ...
            <div className="bg-card border border-border p-8 rounded-lg">
              ...
              <p className="mb-4">
                We understand that every client has unique desires. Suman Escorts boasts the most diverse gallery in India. We offer:
              </p>
              <ul className="list-disc pl-5 space-y-2 text-sm text-muted-foreground">
                ...
                <li><strong>Russian & Foreign VIPs:</strong> For those who desire an exotic, international standard of luxury companionship right here in India.</li>
